...
int main () {
    ...
    while( c != 53) {
      ...
      //Stating next hand on loop
      if(nextHand == "Y" || nextHand == "y") { std::cout << "Starting next hand "<< std::endl; std::cout << std::endl;}
      ...
      if (Deck[c].getName() == "ace") {
        ...
        switch (temp) {
          ...
          case 3: playerAceS = Deck[c].getValue(); break;
          case 4: playerAceC = Deck[c].getValue(); break;
          default : break;
        }
      } else {
      ...
      while (answer == "H" || answer == "h") {
          ...
          // reSetting the Aces should you go over 21
            if (dealerCard1 + dealerCard2 + dealerAceH + dealerAceD + dealerAceS + dealerAceC > 21) {
              if ( dealerAceH == 11) {
                dealerAceH = 1;
            ...
            if (dealerFinalHand < 21 && dealerFinalHand < playerFinalHand) { answer = "H";}
            if (dealerFinalHand == 21 || dealerFinalHand >= playerFinalHand) { answer = "S";}

            if (dealerFinalHand == 21) { std::cout << "BLACK JACK! for Dealer " << std::endl; break;}
